...
class GameViewModel(
    ...
    fun checkAnswer(userAnswer: String, leftNumber: String, correctAnswer: String): Boolean {
        val userAnswerInt = userAnswer.toInt()
        val leftNumberInt = leftNumber.toInt()
        val correctAnswerInt = correctAnswer.toInt()
        return userAnswer + leftNumber == correctAnswer
    }
